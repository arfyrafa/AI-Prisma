...
export function SettingsPage() {
 ...
 ID: <span className="font-semibold text-slate-700">{user?.engineerId}</span> · {user?.email}
 </p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 <span className="rounded-lg bg-emerald-50 border border-emerald-200 px-3 py-1.5 text-xs font-bold text-emerald-700">
 ...
 <p className="text-xl font-mono font-bold text-slate-900">{users.length}</p>
 </div>
 <Users className="h-6 w-6 text-slate-400" />
 </div>
 <div className="rounded-xl border border-purple-200 bg-purple-50/50 p-3 flex items-center justify-between">
 <div>
 <p className="text-[10px] uppercase font-bold text-purple-600">Administrator</p>
 <p className="text-xl font-mono font-bold text-purple-700">{totalAdmins}</p>
 </div>
 <ShieldCheck className="h-6 w-6 text-purple-500" />
 </div>
 <div className="rounded-xl border border-sky-200 bg-sky-50/50 p-3 flex items-center justify-between">
 <div>
 <p className="text-[10px] uppercase font-bold text-sky-600">Process Operator</p>
 <p className="text-xl font-mono font-bold text-sky-700">{totalOperators}</p>
 </div>
 ...
 return (
 <tr key={u.id} className="hover:bg-slate-50/80:bg-slate-800/40 transition-colors">
 <td className="py-3 px-3.5">
 <div className="flex items-center gap-2.5">
 <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-200 text-slate-700 font-bold text-xs">
 ...
 {u.name}
 {isSelf && (
 <span className="rounded bg-sky-100 px-1.5 py-0.2 text-[9px] font-bold text-sky-700">
 Anda
 </span>
 )}
 </p>
 ...
 className="rounded-lg border border-slate-200 p-1.5 text-slate-600 hover:bg-slate-100:bg-slate-800"
 ...
 className="rounded-lg border border-rose-200 p-1.5 text-rose-600 hover:bg-rose-50:bg-rose-950/50 disabled:opacity-30"
 ...
 PRISMA <span className="text-sky-600 font-bold">AI</span>
 </span>
 </div>
 ...
 <dd className="mt-0.5 font-semibold text-emerald-700">{health?.status ?? 'Online'}</dd>
 </div>
 <div>
 <dt className="font-bold text-slate-400 uppercase text-[10px]">Database Telemetri</dt>
 <dd className="mt-0.5 font-semibold text-slate-700">{health?.database ?? 'SQLite'}</dd>
 </div>
 <div>
 <dt className="font-bold text-slate-400 uppercase text-[10px]">AI Provider</dt>
 <dd className="mt-0.5 font-mono font-bold text-sky-700">{health?.agent_provider ?? 'openclaw'}</dd>
 </div>
 <div>
 <dt className="font-bold text-slate-400 uppercase text-[10px]">Tipe Akses Sesi</dt>
 <dd className="mt-0.5 font-semibold text-purple-700">{user?.role} Mode</dd>
 </div>
 </dl>
