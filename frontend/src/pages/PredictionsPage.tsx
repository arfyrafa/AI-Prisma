...
export function PredictionsPage() {
 ...
 <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
 <div className="flex justify-between items-baseline">
 <label className="text-xs font-bold text-slate-800">NaClO₃ Conc.</label>
 ...
 <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
 <div className="flex justify-between items-baseline">
 <label className="text-xs font-bold text-slate-800">NaCl Conc.</label>
 ...
 <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
 <div className="flex justify-between items-baseline">
 <label className="text-xs font-bold text-slate-800">HCl Feed</label>
 ...
 <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
 <div className="flex justify-between items-baseline">
 <label className="text-xs font-bold text-slate-800">HCl Conc.</label>
 ...
 <div className="space-y-2 rounded-xl bg-slate-50 p-4 border border-slate-100">
 <div className="flex justify-between items-baseline">
 <label className="text-xs font-bold text-slate-800">Chilled H₂O Temp</label>
 ...
 <p className="tabular mt-1 font-mono text-3xl font-bold text-slate-900">
 {formatNumber(currentValue ?? latest.actual_value, 2)}
 </p>
 <p className="mt-1 text-xs text-slate-400">{latest.unit}</p>
 </div>
 <div className="rounded-xl border border-purple-300/60 bg-purple-50/70 p-4">
 <p className="eyebrow text-purple-700">Prediksi Model</p>
 <p className="tabular mt-1 font-mono text-3xl font-bold text-purple-700">
 ...
 <p className="tabular mt-1 font-mono text-3xl font-bold text-sky-600">
